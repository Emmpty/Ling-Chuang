<template>
	<view :style="{'background':cueTheme=='day-theme'?'#fff':'#141416','padding-bottom':'300rpx'}">
...
<script>
  import {moveOutCollect} from '../../static/api/index.js'
	import helangWaterfallItem from "./collection-item.vue"
