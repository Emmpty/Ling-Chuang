<template>
	<view style="border: 1px solid red;" >
		<view class="waterfall" :style="{'background':cueTheme=='day-theme'?'#fff':'#141416',}">
			<view v-for="(item, index) in columnData" :key="index" class="column" :style="{ width: columnWidth + 'px' }">
				<view v-for="(childItem, childIndex) in item" :key="childIndex" style="width: 100%"
					...
					<view class="item" :style="'background-color:'+cardBgColor+';margin:'+margin+'rpx;border-radius:'+radius+'rpx;'">
						<image :src="childItem.thumbUrl" mode="widthFix" lazy-load :style="{height:childItem.height,width: '100%'}">
						</image>
