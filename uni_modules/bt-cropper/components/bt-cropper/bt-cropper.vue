		...
		<!-- #endif -->
			<template v-if="imageRect && cropperRect">
				...
				<!-- #endif -->
					...
					<!-- #ifdef APP-VUE || MP-WEIXIN || MP-QQ || H5  -->
					<view class="controller vertical left"  data-type="controller" />
					<view class="controller vertical right"  data-type="controller" />
					<view class="controller horizon top"  data-type="controller" />
					<view class="controller horizon bottom"  data-type="controller" />
					<view class="controller left top"  data-type="controller" />
					<view class="controller left bottom"  data-type="controller" />
					<view class="controller right top"  data-type="controller" />
					<view class="controller right bottom" data-type="controller" />
