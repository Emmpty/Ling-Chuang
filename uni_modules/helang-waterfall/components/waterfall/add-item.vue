<template>
	<view class="waterfall-item-container" :style="{'background':cueTheme=='day-theme'?'#f5f5f5':'#262628'}">
		<view class="waterfall-item" @tap="onTap">
			<image class="icon" :src="params.statusBox? '../../../../static/img/clip/status_active.png':'../../../../static/img/clip/status.png'"  />
			...
			<view class="defeated" v-if="params.status <0" style="color:#FF6850;" @click="albumDetails(params.id)">制作失败</view>
